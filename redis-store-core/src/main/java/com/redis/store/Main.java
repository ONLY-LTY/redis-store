...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        RegistryService.registerNode("redis_cluster_test", ClusterType.REDIS,node,true,false);
        ...
        RegistryService.registerInstance("redis_cluster_test",ClusterType.REDIS,"redis_cluster_1_node_1",instance,true,false);
